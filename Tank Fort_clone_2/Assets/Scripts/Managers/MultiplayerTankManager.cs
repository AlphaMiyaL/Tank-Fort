...
public class MultiplayerTankManager
{
    ...
    private TankMovementMultiplayer m_Movement;                        // Reference to tank's movement script, used to disable/enable control
    ...
    public void Setup()
    {
        ...
        m_Movement = m_Instance.GetComponent<TankMovementMultiplayer>();
